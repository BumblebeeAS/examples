#!/usr/bin/env python3
"""
BlueROV2 action/service registry and TreeNode for mission_planner_release integration.
"""
import rclpy.action
...
from mission_planner_release.common.config.generic_registry import (
    ActionRegistry,
    ServiceRegistry,
    SharedAction,
    SharedService,
)
from mission_planner_release.common.core.tree_node import TreeNode


class BlueROVSharedAction(SharedAction):
    LOCOMOTION = ActionRegistry("/bluerov/controls", Locomotion)
    CLUSTER = ActionRegistry("/bluerov/cluster_poses", ClusterPosesAction)
